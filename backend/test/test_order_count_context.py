...
# 3. 查询模式切换：value → trend
trend_first = run_langgraph_agent(
    question="最近订单量怎么样？",
    conversation_history=[],
    structured_context={},
    structured_memory=[]
...
trend_second = run_langgraph_agent(
    question="看看变化呢？",
    conversation_history=trend_first["conversation_history"],
    structured_context=trend_first["structured_context"],
    structured_memory=trend_first["structured_memory"]
)

print("\n================")
print("趋势切换第一轮")
print("理解:", trend_first["understanding"])
print("回答:", trend_first["answer"])
print("上下文:", trend_first["structured_context"])

print("\n================")
print("趋势切换第二轮")
print("理解:", trend_second["understanding"])
print("实体:", trend_second["entities"])
print("计划:", trend_second["plan"])
print("结果:", trend_second["results"])
print("回答:", trend_second["answer"])
print("上下文:", trend_second["structured_context"])
print("成功:", trend_second["success"])
print("错误:", trend_second["error"])